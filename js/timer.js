...
class CountdownTimer {
    ...
    _calc() {
        ...
        this._out.hoursTitle = CountdownTimer.declensionNum(hours, ['tunti', 'tuntia', 'tunteja']);
        this._out.minutesTitle = CountdownTimer.declensionNum(minutes, ['minuutti', 'minuuttia', 'minuutteja']);
        this._out.secondsTitle = CountdownTimer.declensionNum(seconds, ['sekunti', 'sekuntia', 'sekunteja']);
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    (function timer() {
        const deadline = new Date(Date.now() + (15 * 60 * 1000 + 999));
